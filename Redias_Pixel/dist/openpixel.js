(function (
                    ...
                    return _objectSpread(
                        {
                            ...
                            // website Id
                            userid: function uid() {
                                sessionStorage.setItem("userid", Cookie.get("uid"));
                                return Cookie.get("uid");
                            },
                            // user Id
                            event: function ev() {
                                sessionStorage.setItem("event", _this.event);
                                return _this.event;
                            },
                            ...
                            pixel_version: function v() {
                                return Config.version;
                            },
                            // openpixel.js version
                            location_url: function dl() {
                                sessionStorage.setItem("location_url", location.href);
                                return window.location.href;
                            },
                            // document location
                            referrer_url: function rl() {
                                sessionStorage.setItem("referrer_url", document.referrer);
                                return document.referrer;
                            },
                            // referrer location
                            timestamp: function ts() {
                                sessionStorage.setItem("timestamp", _this.timestamp);
                            ...
                            // document title
                            browser: function bn() {
                                sessionStorage.setItem("browser", Browser.nameAndVersion());
                            ...
                            useragent: function ua() {
                                sessionStorage.setItem("useragent", Browser.userAgent());
                            ...
                            // user Meta Content
                            metacontent: function tt() {
                                try {
                                    var MetaC = document
                                        .getElementsByName("description")[0]
                                        .getAttribute("content");
                                } catch (err) {
                                    var MetaC = "No Content";
                                }
                                return MetaC;
                            },
                            //interests
                            interest: function interest() {
                                try {
                                    return sessionStorage.getItem("interest");
                                } catch (err) {
                                    var value = "Error";
                                    return value;
                                }
                            ...
                            // Meta Keywords
                            metakeywords: function mk() {
                                try {
                                    var MetaK = document
                                        .getElementsByName("keywords")[0]
                                        .getAttribute("content");
                                } catch (err) {
                                    var MetaK = "No Keywords";
                                }
                                return MetaK;
                            },
                            // Get Country
                            ...
                            isp: function isp() {
                                try {
                                    return sessionStorage.getItem("ISP");
                                } catch (err) {
                                    var value = "Error";
                                    return value;
                                }
                            ...
                            ip: function ipt() {
                                try {
                                    return sessionStorage.getItem("IPType");
                                } catch (err) {
                                    var value = "Error";
                                    return value;
                                }
                            ...
                            gi: function gi() {
                                try {
                                    return sessionStorage.getItem("IPadrs");
                                } catch (err) {
                                    var value = "Error";
                                    return value;
                                }
    ...
    window["opix"],
    "opix",
    "https://rediads.com/code/Rediads_Pixel/pixeldata.php",
    1
);
