(function (
  ...
  var Pixel = /*#__PURE__*/ (function () {
    ...
    _createClass(Pixel, [
        ...
        value: function buildParams() {
          ...
          for (var index in attr) {
            if (attr.hasOwnProperty(index)) {
              ...
              this.setParamGA(index, attr[index](index));
            }
          }
        },
      },
      ...
      {
        key: "setParamGA",
        value: function setParamGA(key, val) {
          if (Helper.isPresent(val)) {
            this.paramsGA[key] = val;
          }
        },
      },
      {
      ...
      {
        key: "sendga",
        value: function sendga() {
          if(window.ga){

            const _category = 'promotR';
            const _action = this.paramsGA['uid'] || 'uid'
            const _label  = this.params.join('&');
            window.ga('send', 'event', _category, _action, _label);
...
})(window, document, window["opix"], "opix", "/openpixel/pixel.js", 1);
